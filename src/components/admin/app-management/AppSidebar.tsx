...
const MENU_ITEMS = [
  ...
  {
    /**
     * Content served to people who are NOT enrolled at Abhigyan Gurukul.
     * Kept as its own category rather than folded into Academics, because the
     * audience is the distinction that matters: everything under Academics is
     * batch- and class-scoped to enrolled students, everything here is public.
     */
    category: "Public Learning",
    items: [
      {
        name: "Tests & Series",
